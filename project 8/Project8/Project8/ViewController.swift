...
//  Project8
//
//  Created by Павел Тимофеев on 26.04.2021.
//
...
class ViewController: UIViewController {
    ...
    override func loadView() {
      ...
      scoreLabel = UILabel()
        ...
        submit.addTarget(self, action: #selector(submitTapped), for: .touchUpInside) // conect button with my code throw selector submitTapped
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            var splitAnswers = answersLabel.text?.components(separatedBy: "\n"  // split text from level.1.txt to lines
            )
            ...
            score -= 1
            let ac = UIAlertController(title: "Hey", message: "You are Wrong", preferredStyle: .alert)
