...
//  Progect 27
//
//  Created by Павел Тимофеев on 17.07.2021.
//
...
class ViewController: UIViewController {
    ...
    func drawImagesAndText() {
        ...
        let image = renderer.image { (ctx) in
            ...
            let string = "Timofeev Pavel is the best\n IOS is very great platform\n Tim Cook, helloœ"
            
            let atributedString = NSAttributedString(string: string, attributes: atters)
